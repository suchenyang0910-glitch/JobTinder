...
@Module({
  ...
  providers: [UserIdentityService, CandidateOnboardingService, CompanyOnboardingService],
  exports: [UserIdentityService, CandidateOnboardingService, CompanyOnboardingService],
})
