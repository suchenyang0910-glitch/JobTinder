...
export const AppEnvSchema = z.object({
  ...
  CRAWLER_LIFECYCLE_STALE_CRON: z.string().default('0 0 * * * *'),
  CRAWLER_LIFECYCLE_EXPIRE_CRON: z.string().default('0 0 1 * * *'),
  CRAWLER_LIFECYCLE_NOTIFY72H_CRON: z.string().default('0 30 9 * * *'),
  MATCH_24H_REMINDER_CRON: z.string().default('0 15 * * * *'),
  MATCH_72H_PAUSE_CRON: z.string().default('0 45 * * * *'),
  PILOT_DAILY_REPORT_CRON: z.string().default('0 0 9 * * *'),
  REMOTE_SOURCE_SYNC_CRON: z.string().default('0 0 */6 * * *'),
  REMOTE_NORMALIZE_CRON: z.string().default('0 30 */6 * * *'),
  REMOTE_ELIGIBILITY_CRON: z.string().default('0 0 7 * * *'),
  REMOTE_DAILY_DIGEST_CRON: z.string().default('0 0 9 * * *'),
