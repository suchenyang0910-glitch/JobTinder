...
export const SOURCE_REVIEW_STATUS_TRANSITIONS: Record<
  ...
  SourceReviewStatusValue[]
> = {
  PENDING: ['APPROVED', 'REJECTED', 'SUSPENDED', 'DEFERRED'],
  APPROVED: ['SUSPENDED', 'REJECTED', 'PENDING', 'DEFERRED'],
  REJECTED: ['PENDING', 'APPROVED', 'DEFERRED'],
  DEFERRED: ['PENDING', 'APPROVED', 'REJECTED', 'SUSPENDED'],
  SUSPENDED: ['PENDING', 'APPROVED', 'REJECTED', 'DEFERRED'],
};
